...
const PrivacyPolicyPage = () => {
  return (
    <Layout>
      <Helmet>
        <title>Privacy Policy | D&D Tiefling Name Generator</title>
        <meta name="description" content="Our privacy policy explains how we collect, use and protect your personal information when you use the D&D Tiefling Name Generator website and services." />
        <link rel="canonical" href="https://dndtieflingnamegenerator.com/privacy-policy" />
      </Helmet>
